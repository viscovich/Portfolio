...
import { ArrowLeft, BarChart2, RefreshCw, Download, Trash2 } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchPortfolio = async () => {
      ...
      try {
        ...
        setChartData(getRandomChartData(30, data?.metrics?.return_3y > 0 ? 'up' : 'down'));
      } catch (error) {
                      ...
                      <div className="h-8 w-20">
                        <svg viewBox="0 0 100 30" className="h-full w-full">
                          <path
                            ...
                            fill="none"
                            stroke={asset.asset.metrics?.return_3y > 0 ? "#10b981" : "#ef4444"}
                            strokeWidth="2"
                          />
                        </svg>
                      </div>
